 <div class="modal fade " id="modal-eliminar-{{$cat->id}}">
  {!! Form::open(['route'=>['categorias.destroy',$cat->id ],'method'=>'DELETE']) !!}
	<div class="modal-dialog" id>
		<div class="modal-content">
			<div class="modal-header" style="background:#CD6155;">
				...
				<h4 class="modal-title" style="color:#FFFFFF;"><strong>Eliminar Categoría</strong></h4>
			</div>
